const app = new Vue({
    ...
    computed: {
        ...
        totalPrice() {
            ...
            //  但是这样写，你也多出来一步，我们在for循环里拿索引值的最终目的是拿到book，下面3的做法就能拿到数组中的每一项item。
            ...
            /* 4.1 JavaScript的高阶函数——reduce
            你得拿到一个数组，然后对数组进行reduce操作 */
            return this.books.reduce(function (preValue, book) { /**这里遍历的不再是n，而拿到的应该是一个个书对象**/
